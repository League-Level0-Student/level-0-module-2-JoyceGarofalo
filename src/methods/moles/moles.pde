...
drawMole(200,200);
drawMole(70,119); //calls variable name
drawMole(300,60);
drawMole(297,350);
}

void drawMole(int moleX, int moleY) { //variable being called and everything under
     noStroke();
     fill(125, 93, 43);
...
void setup() {
     ...
     ellipse(297, 350, 100, 30); //x y length width
}